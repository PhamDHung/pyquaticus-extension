...
if __name__ == '__main__':
    ...
    parser.add_argument('load',help='Load Path of Policy to continue training from')
    ...
    env.close()
    ppo_config = PPOConfig().environment(env='pyquaticus').rollouts(num_rollout_workers=1).resources(num_cpus_per_worker=1, num_gpus=1)
